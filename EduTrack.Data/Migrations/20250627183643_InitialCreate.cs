        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Schools_SchoolId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassLessons_Users_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notes_ClassLessons_ClassLessonClassId_ClassLessonLessonId",
                        columns: x => new { x.ClassLessonClassId, x.ClassLessonLessonId },
                        principalTable: "ClassLessons",
                        principalColumns: new[] { "ClassRoomId", "LessonId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notes_ClassUsers_ClassUserClassId_ClassUserUserId",
                        columns: x => new { x.ClassUserClassId, x.ClassUserUserId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_ClassLessonClassId_ClassLessonLessonId",
                table: "Notes",
                columns: new[] { "ClassLessonClassId", "ClassLessonLessonId" });

            migrationBuilder.CreateIndex(
                name: "IX_Notes_ClassUserClassId_ClassUserUserId",
                table: "Notes",
                columns: new[] { "ClassUserClassId", "ClassUserUserId" });
